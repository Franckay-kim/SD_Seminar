...
table 51532171 "Savings Interest Header"
{
    ...
    fields
    {
        field(1; "No."; Code[30])
        {
            ...
            begin
                if "No." <> xRec."No." then begin
                    NoSetup.Get;
                    NoSeriesMgt.TestManual(NoSetup."FOSA Interest Nos");
                    "No. Series" := '';
                end;
        ...
        field(13; "Shortcut Dimension 1 Code"; Code[30])
        {
            CaptionClass = '1,2,1';
        ...
        field(14; "Shortcut Dimension 2 Code"; Code[30])
        {
            CaptionClass = '1,2,2';
        ...
        field(18; "Overdraft Interest"; Boolean)
        {
        }
        field(19; "Auto Process"; Boolean)
        {
        }
    }
    ...
    keys
    {
        key(Key1; "Start Date", "Overdraft Interest")
        {
        }
    }
    ...
    begin
        if "No." = '' then begin
            ...
            NoSeriesMgt.InitSeries(NoSetup."FOSA Interest Nos", xRec."No. Series", 0D, "No.", "No. Series");
        end;
