/// <summary>
/// Table Imprest Surrender Header (ID 51532213).
/// </summary>
table 51532213 "Imprest Surrender Header"
{
    ...
    fields
    {
        ...
        {
            TableRelation = "Imprest Header"."No." where(Posted = filter(true), "Account No." = field("Account No."));
            ...
            begin
                ...
                if ImpSurrLine.FindSet() then ImpSurrLine.DeleteAll();
