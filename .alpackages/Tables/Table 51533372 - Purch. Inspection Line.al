...
table 51533372 "Purch. Inspection Line"
{
    ...
    fields
    {
        ...
        field(3; "Document No."; Code[20])
        {
            ...
            begin
                ...
                PurchRcptLine.RESET;
                PurchRcptLine.SETRANGE(PurchRcptLine."Document No.", "Document No.");
                IF PurchRcptLine.FIND('-') THEN BEGIN
                    /* #pragma warning disable AL0603
                                        Type := PurchRcptLine.Type;
                    #pragma warning restore AL0603 */
                    "No." := PurchRcptLine."No.";
                    Description := PurchRcptLine.Description;
                    "Unit of Measure" := PurchRcptLine."Unit of Measure";
        ...
        field(50000; "Quantity Accepted"; Integer)
        {
        }
        field(50001; "Quantity Rejected"; Integer)
        {
        }
        field(50002; Remarks; Text[100])
        {
        }
        field(50003; Brand; Text[50])
        {
        }
    ...
    keys
    {
        key(Key1; "Document No.", "Line No.", "Buy-from Vendor No.")
        {
        }
