table 51532201 "Cash Office User Template"
{
    ...
    //DrillDownPageID = 51532234;
    //LookupPageID = 51532234;
    ...
    fields
    {
        ...
        field(10; "Default Receipts Bank"; Code[20])
        {
            ...
            //TableRelation = "Bank Account"."No." WHERE("Bank Type" = FILTER(Cash | "Chq Collection" | Cashier | Normal));
        ...
        field(12; "Default Petty Cash Bank"; Code[20])
        {
            ...
            // TableRelation = "Bank Account"."No." WHERE("Bank Type" = FILTER(Cashier | Cash));
